      ...
      >
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          ...
          <div
            style={{
              ...
              gap: 8,
              padding: '8px 10px',
              border: '1px solid rgba(95,185,143,0.35)',
              background: 'rgba(95,185,143,0.08)',
            }}
          >
            ...
            <span style={{ fontSize: 11, color: '#8E8E8E' }}>
              · Assinatura verificada · {new Date().toLocaleDateString('pt-BR')}
            </span>
          </div>
          ...
          {postTab === 'COMENTÁRIOS' && (
            <div>
              {[
                {
                  author: selectedPost.author.split(' ')[0],
                  initials: selectedPost.initials,
                  text: selectedPost.mainComment,
                  time: '2h',
                },
                {
                  author: 'Camila Alves',
                ...
                >
                  <div
                    style={{
                      width: 32,
                      height: 32,
                      background: 'rgba(58,143,222,0.25)',
                      display: 'flex',
                      alignItems: 'center',
                  ...
                  <div>
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 3 }}>
                      <span style={{ fontSize: 12, color: '#E4E4E4', fontWeight: 500 }}>
                        {c.author}
                      </span>
                      <span style={{ ...M, fontSize: 10, color: '#8E8E8E' }}>{c.time}</span>
                    </div>
                    <p style={{ fontSize: 12, color: '#8E8E8E', margin: 0, lineHeight: 1.5 }}>
                      {c.text}
                    </p>
                  </div>
                </div>
            ...
            <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 8 }}>
              {Array.from({ length: selectedPost.audioNotes }).map((_, i) => (
                ...
                >
                  ...
                  <div
                    style={{ flex: 1, height: 28, display: 'flex', alignItems: 'flex-end', gap: 1 }}
                  >
                  ...
                  <span style={{ ...M, fontSize: 10, color: '#8E8E8E', flexShrink: 0 }}>
                    0:{String(14 + i * 8).padStart(2, '0')}
                  </span>
                </div>
              ))}
            </div>
        ...
        >
          ...
          <button
            style={{
              padding: '6px 10px',
              background: comment ? '#3A8FDE' : 'transparent',
              border: `1px solid ${comment ? '#3A8FDE' : '#3C3C3C'}`,
              fontSize: 12,
              color: comment ? '#0D0D0D' : '#8E8E8E',
              cursor: 'pointer',
            }}
          >
        ...
        {posts.map((post) => (
          <div
            ...
            onClick={() => {
              ...
              setPostTab('Comentários');
            }}
          >
            {/* Author row */}
            <div
              style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 12px 8px' }}
            >
              <div
                style={{
                  width: 34,
            ...
            <div style={{ padding: '8px 12px 12px' }}>
              <div style={{ fontSize: 14, color: '#E4E4E4', fontWeight: 500, marginBottom: 6 }}>
                {post.title}
              </div>
