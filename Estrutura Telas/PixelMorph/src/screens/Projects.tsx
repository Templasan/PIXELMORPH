    ...
    >
      ...
      {multiSelect ? (
        ...
        >
          ...
          <span style={{ flex: 1, fontSize: 14, color: '#E4E4E4' }}>
      ...
      <div style={{ margin: '12px 12px 4px', background: '#2F2F2F', display: 'flex' }}>
        ...
        <div style={{ padding: '8px 12px' }}>
          <div style={{ fontSize: 12, color: '#E4E4E4', fontWeight: 500 }}>
              ...
              >
                ...
                {project.isVideo && (
                  <>
                    ...
                    >
                      <span style={{ ...S, fontSize: 10, color: '#E4E4E4' }}>
                        {project.duration}
                      </span>
                    </div>
                  </>
      ...
      {multiSelect && selected.length > 0 && (
        <div
          style={{ background: '#252525', borderTop: '1px solid #3C3C3C', padding: '12px 16px' }}
        >
          <div
            style={{
              fontSize: 10,
            ...
            {infoTab === 'PROPRIEDADES' ? (
              <div>
                {[
                  ...
                  ['Tipo', infoProject.type],
                  ['Dimensões', '6000 × 4000'],
                  ['Tamanho', '42,3 MB'],
                  ['Espaço de cor', 'Adobe RGB'],
                  ['Taxa de bits', '24 bits'],
                  ['Codificação', 'JPEG Baseline'],
                  ['ISO', '400'],
                  ['Abertura', 'f/2.8'],
                  ['Data', infoProject.date],
                ].map(([k, v]) => (
                  <div
                    key={k}
                    style={{
              ...
              <div>
                {[
                  ['14:32', 'Ajuste de curvas aplicado'],
                  ['14:15', 'Saturação +20'],
                  ['13:58', 'Recorte 16:9'],
                  ['13:40', 'Abertura do arquivo'],
                ].map(([time, action]) => (
                  <div
                    key={time}
                    style={{
                  ...
                  >
                    <span
                      style={{ ...S, fontSize: 12, color: '#8E8E8E', width: 40, flexShrink: 0 }}
                    >
                      {time}
                    </span>
