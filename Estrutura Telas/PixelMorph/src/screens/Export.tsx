...
function Slider({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '5px 0' }}>
      ...
      >
        <div
          style={{ position: 'absolute', left: 0, right: 0, height: 2, background: '#3C3C3C' }}
        />
        <input
          type="range"
          min={min}
        ...
        {exportState === 'done' ? (
          ...
          >
            <div style={{ position: 'relative' }}>
              <div
                style={{ width: 80, height: 80, overflow: 'hidden', border: '1px solid #3C3C3C' }}
              >
                <img
                  src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=80&h=80&fit=crop&auto=format"
                  alt="Exported"
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 15, fontWeight: 500, color: '#E4E4E4' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '12px 16px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      ...
                      {['JPEG', 'PNG', 'WebP', 'HEIC', 'GIF'].map((f) => (
                        <button
                          ...
                          style={{
                            padding: '5px 14px',
                            fontSize: 12,
                            border: `1px solid ${format === f ? '#3A8FDE' : '#3C3C3C'}`,
                            color: format === f ? '#3A8FDE' : '#8E8E8E',
                            background: 'transparent',
                            cursor: 'pointer',
                          }}
                        >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span style={{ ...M, fontSize: 11, color: '#E4E4E4' }}>
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          height: 12,
                          background: '#E4E4E4',
                          left: `calc(${((quality - 10) / 90) * 100}% - 6px)`,
                          pointerEvents: 'none',
                        }}
                      />
                    </div>
                      ...
                      {['Original', '2K', '1080p', '720p'].map((s) => (
                        <button
                          ...
                          style={{
                            padding: '5px 12px',
                            fontSize: 12,
                            border: `1px solid ${sizeChip === s ? '#3A8FDE' : '#3C3C3C'}`,
                            color: sizeChip === s ? '#3A8FDE' : '#8E8E8E',
                            background: 'transparent',
                            cursor: 'pointer',
                          }}
                        >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                      ...
                      {['72', '150', '300', '600'].map((d) => (
                        <button
                          ...
                          style={{
                            padding: '5px 12px',
                            fontSize: 12,
                            border: `1px solid ${d === '300' ? '#3A8FDE' : '#3C3C3C'}`,
                            color: d === '300' ? '#3A8FDE' : '#8E8E8E',
                            background: 'transparent',
                            cursor: 'pointer',
                            ...M,
                          }}
                  ...
                  <div
                    style={{
                      ...
                      gap: 8,
                      padding: '8px 10px',
                      background: 'rgba(210,160,94,0.1)',
                      border: '1px solid rgba(210,160,94,0.3)',
                    }}
                  >
                    <Icon name="triangle" size={14} color="#D2A05E" />
                    <span style={{ fontSize: 11, color: '#D2A05E', lineHeight: 1.4 }}>
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: 14,
                            borderRadius: '50%',
                            border: `1px solid ${cs === 'Adobe RGB' ? '#3A8FDE' : '#3C3C3C'}`,
                            background: cs === 'Adobe RGB' ? '#3A8FDE' : 'transparent',
                          }}
                        />
              ...
              {tab === "MARCA D'ÁGUA" && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  >
                    <img
                      src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=320&h=180&fit=crop&auto=format"
                      alt="Preview"
                    ...
                    <div
                      style={{
                        ...
                        right: 10,
                        fontSize: 12,
                        color: `rgba(228,228,228,${opacity / 100})`,
                        fontFamily: 'Roboto',
                        userSelect: 'none',
                      }}
                    >
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 6 }}>
                    {['↖', '↑', '↗', '←', '·', '→', '↙', '↓', '↘'].map((p, i) => (
                      <button
                        ...
                        style={{
                          height: 32,
                          border: `1px solid ${i === 8 ? '#3A8FDE' : '#3C3C3C'}`,
                          fontSize: 14,
                          color: i === 8 ? '#3A8FDE' : '#8E8E8E',
                          background: 'transparent',
                          cursor: 'pointer',
                        }}
                      >
