...
function Slider({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '6px 12px' }}>
      ...
      <div
        style={{ flex: 1, height: 20, position: 'relative', display: 'flex', alignItems: 'center' }}
      >
        <div
          style={{
            position: 'absolute',
            ...
            right: 0,
            height: 2,
            background: gradient ? 'linear-gradient(to right, #4477FF, #FF8833)' : '#3C3C3C',
          }}
        />
        {bipolar && !gradient && (
          <div
...
function AdjustDrawer({
  ...
  matiz: number;
  setMatiz: (v: number) => void;
  saturacao: number;
  setSaturacao: (v: number) => void;
  luminosidade: number;
  setLuminosidade: (v: number) => void;
  vibracao: number;
  setVibracao: (v: number) => void;
  exposicao: number;
  setExposicao: (v: number) => void;
}) {
  ...
  return (
    <div>
      <DrawerTabs
        tabs={['Básico', 'Curvas', 'Detalhe', 'Cor seletiva']}
        active={tab}
        onSelect={setTab}
      />
      {tab === 'Básico' && (
        <div>
          ...
          >
            ...
            >
              <path
                d="M0,56 C30,55 50,44 80,18 C100,3 116,8 132,15 C152,23 182,40 222,51 C242,54 252,56 256,56 Z"
                fill="rgba(210,82,82,0.4)"
              />
              <path
                d="M0,56 C30,55 50,44 80,18 C100,3 116,8 132,15 C152,23 182,40 222,51 C242,54 252,56 256,56"
                fill="none"
                stroke="rgba(210,82,82,0.75)"
                strokeWidth="1"
              />
              <path
                d="M0,56 C20,56 40,50 70,26 C95,8 116,13 142,19 C167,27 186,41 216,51 C236,54 248,56 256,56 Z"
                fill="rgba(95,185,143,0.4)"
              />
              <path
                d="M0,56 C20,56 40,50 70,26 C95,8 116,13 142,19 C167,27 186,41 216,51 C236,54 248,56 256,56"
                fill="none"
                stroke="rgba(95,185,143,0.75)"
                strokeWidth="1"
              />
              <path
                d="M0,56 C14,55 28,47 54,20 C74,2 95,7 116,13 C142,21 172,38 212,51 C233,54 246,56 256,56 Z"
                fill="rgba(58,143,222,0.4)"
              />
              <path
                d="M0,56 C14,55 28,47 54,20 C74,2 95,7 116,13 C142,21 172,38 212,51 C233,54 246,56 256,56"
                fill="none"
                stroke="rgba(58,143,222,0.75)"
                strokeWidth="1"
              />
            </svg>
          </div>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 8, padding: '0 12px 8px' }}>
        ...
        >
          <Icon name="flipHorizontal" size={14} color="#8E8E8E" />
          Espelhar H
        </button>
        <button
          style={{
      ...
      <div
        style={{
          ...
          border: '1px solid rgba(210,160,94,0.3)',
          display: 'flex',
          alignItems: 'center',
          gap: 8,
        }}
      >
        ...
        <span style={{ fontSize: 11, color: '#D2A05E' }}>
          Sugestão: recorte 3:2 pela regra dos terços
        </span>
      </div>
    </div>
  );
  ...
  return (
    <div>
      ...
      <div style={{ padding: '4px 12px 8px' }}>
        <div style={{ fontSize: 11, color: '#8E8E8E', marginBottom: 6 }}>
          Ajustes dentro da máscara
        </div>
...
function EfeitosDrawer() {
  ...
  return (
    <div>
      <DrawerTabs
        tabs={['Retrô', 'Molduras', 'Iluminação', 'Dupla exposição', 'Overlays']}
        active={tab}
        onSelect={setTab}
      />
          ...
          >
            <div
              style={{
                width: 56,
                height: 56,
                border: `1px solid ${i === 0 ? '#3A8FDE' : '#3C3C3C'}`,
                background: '#1F1F1F',
              }}
            />
            <span
...
function ElementosDrawer() {
  ...
  return (
    <div>
      <DrawerTabs
        tabs={['Texto', 'Formas', 'Adesivos', 'Meme', 'Colagem']}
        active={tab}
        onSelect={setTab}
      />
      {tab === 'Texto' && (
...
function IADrawer() {
  ...
  return (
    <div>
      ...
      >
        <DrawerTabs
          tabs={['Recorte', 'Retrato', 'Sugestões', 'Artístico']}
          active={tab}
          onSelect={setTab}
        />
        <div
        ...
        >
          ...
          <span style={{ fontSize: 10, color: '#5FB98F', whiteSpace: 'nowrap' }}>
            No dispositivo
          </span>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
          ...
          <span
            style={{
              ...
              border: '1px solid rgba(58,143,222,0.4)',
              fontSize: 11,
              color: '#3A8FDE',
            }}
          >
...
export default function PhotoEditorScreen({ navigate, onOpenDrawer, onExport }: Props) {
  ...
  const imgFilter =
    [
      ...
      exposicao !== 0 || luminosidade !== 0
        ? `brightness(${Math.max(0.1, 1 + exposicao / 100 + luminosidade / 200)})`
        : '',
      matiz !== 0 ? `hue-rotate(${matiz * 1.8}deg)` : '',
      temperatura !== 0
        ? `sepia(${Math.abs(temperatura) / 300}) hue-rotate(${temperatura > 0 ? 12 : -12}deg)`
        : '',
    ]
      .filter(Boolean)
      .join(' ') || 'none';
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ ...M, fontSize: 11, color: '#8E8E8E' }}>
      ...
      >
        <div style={{ position: 'relative' }}>
          ...
          {compareMode && (
            <div
              ...
              style={{ position: 'absolute', inset: 0 }}
              onMouseMove={(e) => {
                if (e.buttons === 1) handleCompareMove(e.clientX);
              }}
          ...
          >
                ...
                return (
                  <div key={layer.key}>
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          setLayersVisible((prev) => ({ ...prev, [layer.key]: !prev[layer.key] }))
                        }
                        style={{
                          background: 'none',
                          border: 'none',
            ...
            <div style={{ borderTop: '1px solid #3C3C3C', padding: 8 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}>
                <span style={{ fontSize: 11, color: '#8E8E8E', width: 56, flexShrink: 0 }}>
                  Opacidade
                </span>
                <input
                  type="range"
        ...
        >
          ...
          <span style={{ ...M, fontSize: 11, color: '#E4E4E4', width: 36, textAlign: 'center' }}>
            {zoom}%
          </span>
          <button
          ...
          <div style={{ flex: 1, overflowY: 'auto' }}>
            {activeTool === 'ajustes' && (
              <AdjustDrawer
                ...
                setMatiz={setMatiz}
                saturacao={saturacao}
                setSaturacao={setSaturacao}
                luminosidade={luminosidade}
                setLuminosidade={setLuminosidade}
                vibracao={vibracao}
                setVibracao={setVibracao}
                exposicao={exposicao}
                setExposicao={setExposicao}
              />
            )}
        ...
        <div style={{ display: 'flex', overflowX: 'auto' }}>
          {TOOLBAR.map(({ id, icon, label }) => (
            ...
            >
              ...
              <span style={{ fontSize: 10, color: activeTool === id ? '#3A8FDE' : '#8E8E8E' }}>
                {label}
              </span>
            </button>
          ))}
