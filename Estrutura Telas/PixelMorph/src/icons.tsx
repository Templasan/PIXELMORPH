const paths: Record<string, string> = {
  ...
  image: 'M21 3H3a2 2 0 00-2 2v14a2 2 0 002 2h18a2 2 0 002-2V5a2 2 0 00-2-2zM8.5 10a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM21 15l-5-5L5 21',
  ...
  scissors: 'M6 3a3 3 0 110 6 3 3 0 010-6zM6 15a3 3 0 110 6 3 3 0 010-6zM20 4L8.12 15.88M15.88 15.88L20 20',
  ...
  robot: 'M12 2a4 4 0 014 4v1h2a2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2V9a2 2 0 012-2h2V6a4 4 0 014-4zM9 13a1 1 0 102 0 1 1 0 00-2 0zM13 13a1 1 0 102 0 1 1 0 00-2 0z',
...
export function Icon({ name, size = 24, color = '#B0B0B0', className = '' }: IconProps) {
  const d = paths[name] ?? 'M18 6L6 18M6 6l12 12';
  return (
    <svg
      width={size}
      height={size}
